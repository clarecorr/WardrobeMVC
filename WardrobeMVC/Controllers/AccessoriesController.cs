...
namespace WardrobeMVC.Controllers
{
    public class AccessoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AccessoryID,AccessoryName,AccessoryPhoto,AccessoryType,AccessoryColor,SeasonID,OccasionID")] Accessory accessory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AccessoryID,AccessoryName,AccessoryPhoto,AccessoryType,AccessoryColor,SeasonID,OccasionID")] Accessory accessory)
        {
            if (ModelState.IsValid)
            {
