...
namespace WardrobeMVC.Controllers
{
    public class ShoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ShoeID,ShoeName,ShoePhoto,ShoeType,ShoeColor,SeasonID,OccasionID")] Sho sho)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ShoeID,ShoeName,ShoePhoto,ShoeType,ShoeColor,SeasonID,OccasionID")] Sho sho)
        {
            if (ModelState.IsValid)
            {
