...
namespace WardrobeMVC.Controllers
{
    public class BottomsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BottomID,BottomName,BottomPhoto,BottomType,BottomColor,SeasonID,OccasionID")] Bottom bottom)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BottomID,BottomName,BottomPhoto,BottomType,BottomColor,SeasonID,OccasionID")] Bottom bottom)
        {
            if (ModelState.IsValid)
            {
