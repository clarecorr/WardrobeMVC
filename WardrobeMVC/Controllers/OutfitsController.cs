...
namespace WardrobeMVC.Controllers
{
    public class OutfitsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OutfitID,OutfitName,OutfitDate,SeasonID,OccasionID,TopID,BottomID,ShoeID,AccessoryID")] Outfit outfit)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OutfitID,OutfitName,OutfitDate,SeasonID,OccasionID,TopID,BottomID,ShoeID,AccessoryID")] Outfit outfit)
        {
            if (ModelState.IsValid)
            {
