...
namespace WardrobeMVC.Controllers
{
    public class TopsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TopID,TopName,TopPhoto,TopType,TopColor,SeasonID,OccasionID")] Top top)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TopID,TopName,TopPhoto,TopType,TopColor,SeasonID,OccasionID")] Top top)
        {
            if (ModelState.IsValid)
            {
